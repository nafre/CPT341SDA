...
public class CoffeeMakerTest extends TestCase {
	...
	public void testEditRecipe() throws RecipeException {
		...
		System.out.println(cm.getRecipes()[0].getPrice());

		if (cm.getRecipes()[0].getPrice() != 1 || cm.getRecipes()[0].getAmtCoffee() != 2
				|| cm.getRecipes()[0].getAmtMilk() != 3 || cm.getRecipes()[0].getAmtSugar() != 4
				|| cm.getRecipes()[0].getAmtChocolate() != 5) {
			fail();
